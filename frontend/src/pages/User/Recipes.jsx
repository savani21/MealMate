            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <section className="text-center mb-8">
                    ...
                    <p className="text-gray-500 mt-3">
                        Find recipes or create one with AI from your ingredients.
                    </p>

                    <button
                        onClick={() => setShowGenerator(true)}
                        className="mt-5 inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-primary text-white font-semibold hover:opacity-90 transition"
                    >
                ...
                {showGenerator && (
                    <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-8">
                        <div className="flex items-center justify-between mb-5">
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-1">
                                    Tell MealMate what ingredients you have.
                                </p>
                            </div>
                            <button
                        ...
                        <button
                            ...
                            disabled={generating}
                            className="w-full mt-5 py-3 rounded-xl bg-primary text-white font-semibold hover:opacity-90 transition disabled:opacity-50"
                        >
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-4 mb-8 flex flex-col md:flex-row gap-4">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 outline-none focus:border-primary"
                        />
                    </div>
                    ...
                    <select
                        ...
                        className="px-4 py-3 rounded-xl border border-gray-200 bg-white outline-none focus:border-primary"
                    >
                        {categories.map((item) => (
                ...
                {loading ? (
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center">
                        ...
                        <p className="text-gray-500 mt-2">Try another search or generate a recipe with AI.</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredRecipes.map((recipe) => (
                            <RecipeCard
                                key={recipe._id}
                                recipe={recipe}
                                onClick={() => setLocation(`/recipes/${recipe._id}`)}
